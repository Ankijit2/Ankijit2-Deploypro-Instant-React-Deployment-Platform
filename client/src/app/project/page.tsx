        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {projects && projects.map((project) => (
            <Card key={project.id} className="overflow-hidden" onClick={() => router.push(`/project/${project.id}`)}>
              ...
              <CardContent>
                <a href={`${project.subDomain}.${process.env.NEXT_PUBLIC_BASE_URL}`} target="_blank" rel="noopener noreferrer" className="text-primary text-xs hover:underline flex items-center mb-2">
